...
def hide_window():
    ...
    menu=(item('Show', show_window,default=True),item('Quit',quit_window ))#,item('Timeline', show_timeline),item("Primo tracker", show_tracker))
...
class Bar(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        close_button = tk.Button(self, text='  ×  ', command=hide_window,bg=RGRAY,padx=2,pady=2,font=("calibri", 13),bd=0,fg='white',highlightthickness=0)
        topbarTitle = tk.Label(self, text="Genshin companion", bg=RGRAY,bd=0,fg='white',font=("helvetica", 10),highlightthickness=0) 
        config_button = tk.Button(self, text="↻",bg=RGRAY,bd=0,fg='white',font=("Cambria", 13),highlightthickness=0,padx=2,pady=2,width=5)
...
class ProtoBar(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        close_button = tk.Button(self, text='  ×  ', command=stop,bg=RGRAY,padx=2,pady=2,font=("calibri", 13),bd=0,fg='white',highlightthickness=0)
        topbarTitle = tk.Label(self, text="Genshin companion", bg=RGRAY,bd=0,fg='white',font=("helvetica", 10),highlightthickness=0) 
