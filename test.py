...
Imagen1 = Image.open(io.BytesIO(urlopen(banners[0]["img"]).read())).resize((300, 148), Image.LANCZOS)
w, h = Imagen1.size
Imagen1 = Imagen1.crop((w - 220, 0, w - 80, h))

Imagen2 = Image.open(io.BytesIO(urlopen(banners[1]["img"]).read())).resize((300, 148), Image.LANCZOS)
w, h = Imagen2.size
